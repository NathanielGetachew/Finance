...
import { registerAction } from "../../Redux/userslices";
    ...
    <form onSubmit={handleSubmit} className="w-full lg:w-1/2">
      <div className="flex flex-col items-center p-10 xl:px-24 xl:pb-12 bg-white lg:max-w-xl lg:ml-auto rounded-4xl shadow-2xl">
        ...
        <h2 className="mb-4 text-2xl md:text-3xl text-coolGray-900 font-bold text-center">
          Deposit Here, Keep it safe
        </h2>
         {/* Display Error here */}
         { error && <ErrorMsg message= {error?.message}/>}
          {/* Display the success here */}
          { success && <SuccessMsg message= "Registered in Successfully"/>}
        <h3 className="mb-7 text-base md:text-lg text-coolGray-500 font-medium text-center">
          Lorem ipsum dolor sit amet, consectetur adipisng.
        </h3>
        <label className="mb-4 flex flex-col w-full">
          <span className="mb-1 text-coolGray-800 font-medium">First Name</span>
          <input
        ...
        <label className="mb-4 flex flex-col w-full">
          <span className="mb-1 text-coolGray-800 font-medium">Last Name</span>
          <input
            className="py-3 px-3 leading-5 w-full text-coolGray-400 font-normal border border-coolGray-200 outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 rounded-lg shadow-sm"
            type="text"
